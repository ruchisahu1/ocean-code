...
const worlds: World[] = [
  ...
  },
  {
    ...
    description: "Combine all your skills — nested loops, elif, functions, and scanning — to navigate the Open Ocean Abyss and complete the ultimate rescue!",
    levels: 5,
    unlocked: true,
    concept: "Nested Loops & elif",
    glowClass: "box-glow-rose",
    icon: "\uD83C\uDF0C",
  },
];
